...
fnFs <- sort(list.files(path, pattern = "_R1.fastq.gz", full.names = TRUE)) # /!\ It seems that this workflow with cutadapt need gzip files...
...
cutadapt <- "/Users/carteronalexis/.local/bin/cutadapt" # CHANGE ME to the cutadapt path on your machine
