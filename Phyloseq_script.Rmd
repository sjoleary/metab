...
* For practical reasons: Easy to use at first (when you have built the S4 object), quick and nice functions and figures (great FAQ)
* Reproducible reason
* Currently being developed and improved by biostatistician 
