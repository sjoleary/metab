...
#### Pourquoi phyloseq? / <span style="color:darkblue"> Why Phyloseq? </span>
* For practical reasons: Easy to use at first (when you have built the S4 object), quick and nice functions and figures
* Reproducible reason
Other great resources are available (e.g.: [Rhea pipeline](https://lagkouvardos.github.io/Rhea/))
* Currently being developed and improved (great FAQ)
<br>
...
library(ggplot2)
```
Built with R version `r getRversion()` and Phyloseq version `r packageVersion('phyloseq')` and a Linux machine image 4.4.0-64-generic
...
#### Profondeur de sequencage apres filtrage de la canalisation Dada2 / <span style="color:darkblue"> Sequencing depth per samples after filtering of Dada2 pipeline</span>
...
![Map](Other_materials/map_plot3.png)
<br>
...
### 4. Ordination sous contraites: analyse de redondance / <span style="color:darkblue"> Constrained ordination: Redundancy Analysis (RDA) </span>
```{r, include = TRUE, cache = TRUE}
