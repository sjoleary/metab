...
#### Why Phyloseq?  
* For practical reasons: Easy to use at first (once you have built the S4 object), quick and nice functions and figures 
* Improve sharin, storagre and reproducibility
* Currently being developed and improved by biostatistician (great FAQ)  
<br>
Other great resources are available (e.g.: [Rhea](https://lagkouvardos.github.io/Rhea/) pipeline)
<br>
<br>
